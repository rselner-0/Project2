...
{ char response = 'o';
	...
	{
		cout << "Want to play ";
		if (c.number_of_times_played == 0) { cout << "a game?\n\ny/n: "; cin >> response;}
		else { cout << "again?\n\ny/n: "; cin >> response;}
		if (response != 'n')
		{
			if (response == 'y')
		...
		if (response == 'n')
		{
			...
			if (c.number_of_times_played == 0 || c.number_of_times_played > 1) { cout << " times.";}
			else if (c.number_of_times_played == 1) { cout << " time.";}
			cout << "\n\n\n~Bye!~\n" << endl;
		}
	}
	return 6174;
